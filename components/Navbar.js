  ...
  return (
    <main className="bg-white shadow shadow-gray-200 w-full sticky top-0 z-10">
      <div className="flex justify-between h-[50px] pt-3 px-5">
        <h1 className="text-2xl font-bold text-indigo-500 cursor-pointer">
          <Link href="/">FastCash</Link>
        </h1>
        <ul className="hidden md:flex gap-5 md:font-semibold md:cursor-pointer">
          <Link href="/dashboard/get-loan">
            <li>GetLoan</li>
          </Link>
          <Link href="/dashboard/loan-history">
            <li>LoanHistory</li>
          </Link>
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <Link href="/auth/login">
            <button className="w-[60px] h-[30px] text-white bg-indigo-400 rounded cursor-pointer">
              Login
            </button>
          </Link>
        </div>
